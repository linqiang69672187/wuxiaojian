...
OpenLayers.Layer.ArcGISCacheExtent = OpenLayers.Class(OpenLayers.Layer.XYZ, {  
   ...
   /**
    * Constructor: OpenLayers.Layer.ArcGISCacheExtent 
    ...
    */ 
    initialize: function(name, url, options) { 
        ...
        if (this.resolutions) {        
			...
			this.resolutionIndex = options.resolutionIndex;
        }
   ...
   /** 
    * APIMethod: clone 
    * Returns an exact clone of this OpenLayers.Layer.ArcGISCacheExtent
    * 
    * Parameters: 
    * [obj] - {Object} optional object to assign the cloned instance to.
    *  
    * Returns: 
    * {<OpenLayers.Layer.ArcGISCacheExtent>} clone of this instance 
    */ 
    clone: function (obj) { 
        if (obj == null) { 
            obj = new OpenLayers.Layer.ArcGISCacheExtent(this.name, this.url, this.options);
        }
    ...
    */
    getURL: function (bounds) {
        ...
        var z = this.resolutionIndex[this.map.getZoom()];
    ...
    CLASS_NAME: 'OpenLayers.Layer.ArcGISCacheExtent' 
}); 
